...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        String month[]={"January","February","March","April","May","June","July","August","September","August","November","December"};
        ...
        l4.setBounds(100,1900,200,30);
        add(l1);

        t2.setBounds(3000,190,400,30);
        add(t2);
    ...
    public void actionPerformed(ActionEvent arg0) {
        ...
        try{
            if(t6.getText().equals("")){
                ...
                con c1=new con();
                String q1="insert into signup values('"+a+"','"+b+"','"+bc+"','"+cc+"','"+d+"','"+e+"','"+f+"','"+g+"','"+h+"','"+i+"','"+j+"','"+first+"')";
